  ...
  <t-row style="height: 89vh">
    ...
    <t-drawer v-model:visible="visible" size="50%" :header="header"  :close-on-overlay-click="false" :on-confirm="drawerClose" :close-btn="true">
      ...
      <t-row>
        <t-col :span="12">
          <t-input-group class="groups">
            <span class="titles">入库申请单号：</span>
            <t-input type="text" class="rang" placeholder="请输入产品名称" />
          </t-input-group>
        </t-col>

        <t-col :span="6">
          <t-input-group class="groups">
            <span class="titles">入库人：</span>
        ...
        <t-col :span="6">
          <t-input-group class="groups">
            ...
            <t-input type="text" class="ranges" placeholder="请输入复核时间" disabled/>
          </t-input-group>
        </t-col>
      ...
      <template #footer>
        <t-button @click="visibles = true">出库</t-button>
...
for (let i = 1; i <= 11; i++) {
  data.push({
    ...
    wagatherid: '入库申请单号'+i,
    wastorer: '入库人'+i,
    waamountsum: '总件数'+(i*100),
    wacostpricesum: '总金额'+(i*100),
    wagatheredamountsum: i*100,
    waregister: '登记人'+i,
    waregistertime: '2022-10-0'+i,
    wachecker: '复核人'+i,
    wacheckertime: '2022-11-0'+i,
    created: '2022-10-0'+i,
    updated: '2022-11-0'+i,
    wareason: 'R001-1',
    wachecktag: i % 2==0? 'S001-1' : 'S001-2',
    wastoretag: i % 2==0? 'K002-1' : 'K002-2',
    waremark: '备注',
  });
}
...
const columns = ref([
  ...
  { colKey: 'wagatherid', title: '入库申请单号',align: 'center',width: '160px',fixed: leftFixedColumn.value >= 2 ? 'left' : undefined},
  ...
  { colKey: 'wacheckertime', title: '复核时间',align: 'center',width: '120px'},
