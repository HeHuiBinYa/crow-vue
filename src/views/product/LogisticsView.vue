<template>
  <t-drawer v-model:visible="visible" size="50%" :close-on-overlay-click="false" :header="header" :on-confirm="drawerClose" :close-btn="true">
    <t-row>
      <t-col :span="6">
    ...
    <t-col :span="12">
      <t-row class="row">
        ...
        <t-col :span="6" class="col">
          <t-select label="制作产品：" size="large" />
        </t-col>
