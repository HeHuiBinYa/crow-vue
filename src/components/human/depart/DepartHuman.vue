  ...
  <t-drawer v-model:visible="visible" size="medium" :header="header" :on-confirm="drawerClose" :close-btn="true">
    ...
    <t-col :span="12">
      <t-input-group class="groups">
        ...
        <t-select  class="ranges"  placeholder="请输入性别"></t-select>
      </t-input-group>
    </t-col>
    ...
    <t-col :span="12">
      <t-input-group class="groups">
        <span class="titles">部门：</span>
        <t-input type="text" class="ranges" placeholder="请输入部门"/>
      </t-input-group>
    </t-col>
    ...
    <t-col :span="12">
      <t-input-group class="groups">
        ...
        <t-select  class="ranges"  placeholder="请选择您的分配部门"></t-select>
      </t-input-group>
    </t-col>
...
const columns = ref([
  ...
  { colKey: 'entrytime', title: '入职时间',align: 'center'},
  { colKey: 'leavetime', title: '离职时间',align: 'center'},
]);
// 双击
